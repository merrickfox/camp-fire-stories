/**
 * Created by merrick on 03/07/2017.
 */
/**
...
AFRAME.registerComponent('fire-system', {
	...
	initParticleSystem: function(settings) {
		...
		this.particleGroup = new SPE.Group({
			...
			maxParticleCount: totalParticles,
		...
		var emitter = new SPE.Emitter({
			...
			color: {
				value: [new THREE.Color('#ecf240'), new THREE.Color('#ee1438'), new THREE.Color('#ecf240')]
			},
			size: {
				value: [3,0],
			},
